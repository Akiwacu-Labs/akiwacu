...
public class TontineService {
    ...
    public List<TontineResponse> lister() {
        return tontineRepository.findAll().stream().map(this::versResponse).toList();
    }

    public TontineResponse trouverParId(Long id) {
        return versResponse(trouverEntite(id));
    }
    ...
    public void supprimer(Long id) {
        tontineRepository.delete(trouverEntite(id));
    }
